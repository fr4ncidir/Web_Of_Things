...
def PATH_SPARQL_QUERY_TS_TEMPLATE(identifier):
    return resource_filename(__name__, "subscribes/{}_ts.sparql".format(identifier))
...
def PATH_SPARQL_NEW_ACTION_TEMPLATE(identifier):
    return resource_filename(__name__, "updates/new_{}_action.sparql".format(identifier))

def PATH_SPARQL_NEW_EVENT_TEMPLATE(identifier):
    return resource_filename(__name__, "updates/new_{}_event.sparql".format(identifier))

def PATH_SPARQL_NEW_ACTION_INSTANCE_TEMPLATE(identifier):
    return resource_filename(__name__, "updates/new_{}_action_instance.sparql".format(identifier))

def PATH_SPARQL_NEW_EVENT_INSTANCE_TEMPLATE(identifier):
    return resource_filename(__name__, "updates/new_{}_event_instance.sparql".format(identifier))

def PATH_SPARQL_NEW_TS_TEMPLATE(identifier):
    return resource_filename(__name__, "updates/new_{}_ts.sparql".format(identifier))
...
def RES_SPARQL_NEW_ACTION_INSTANCE_TEMPLATE(identifier):
    return resource_filename(__name__, "subscribes/results/res_new_{}_action_instance.json".format(identifier))

def RES_SPARQL_NEW_ACTION_INSTANCE_UPDATE_TEMPLATE(identifier):
    return resource_filename(__name__, "subscribes/results/res_new_{}_action_instance_update.json".format(identifier))

RES_SPARQL_NEW_ACTION_INSTANCE_UPDATE = resource_filename(__name__, "subscribes/results/res_new_action_instance_update.json")

def RES_SPARQL_NEW_EVENT_INSTANCE_TEMPLATE(identifier):
    return resource_filename(__name__, "subscribes/results/res_new_{}_event_instance.json".format(identifier))

def RES_SPARQL_NEW_EVENT_INSTANCE_UPDATE_TEMPLATE(identifier):
    return resource_filename(__name__, "subscribes/results/res_new_{}_event_instance_update.json".format(identifier))

def RES_SPARQL_NEW_TS_TEMPLATE(identifier):
    return resource_filename(__name__, "subscribes/results/res_new_{}_ts.json".format(identifier))
